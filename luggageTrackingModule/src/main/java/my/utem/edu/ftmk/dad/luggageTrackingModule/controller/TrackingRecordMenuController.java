...
private String defaultURI = "http://localhost:8080/luggagehandling/api/trackingrecords";
	...
	@GetMapping("/trackingrecords/list")
	public String getTrackingrecords (Model model)
	{
		...
		Trackingrecord trackings[] = response.getBody();
		
		
		// Parse an array to a list object
		List<Trackingrecord> trackinglist = Arrays.asList(trackings);
		
		// Attach list to model as attribute 
		model.addAttribute("trackingrecords", trackinglist);
