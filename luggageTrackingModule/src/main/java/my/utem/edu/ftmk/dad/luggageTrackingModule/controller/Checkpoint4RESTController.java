...
public class Checkpoint4RESTController {
	...
	@DeleteMapping("{cp4ID}")
	public ResponseEntity<HttpStatus> deleteCheckpoint4(@PathVariable long cp4ID)
	{
	...
	@GetMapping ("{cp4ID}")
	public Checkpoint4 getCheckpoint4(@PathVariable long cp4ID )
	{
		Checkpoint4 checkpoint4 = checkpoint4Repository.findById(cp4ID).get();
